...
Given a quadratic space $(V, q)$, we define the \emph{Witt index}\index{Witt index} of $(V, q)$ to be the maximal possible dimension of a totally isotropic subspace $W$ of $(V, q)$ with $V \cap W = \lbrace 0 \rbrace$.
